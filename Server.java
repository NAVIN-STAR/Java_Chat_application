...
import static chatting.app.Client.format;
import static chatting.app.Client.vertical;
import java.awt.*;
import javax.swing.*; 
...
public class Server  implements ActionListener
{
    ...
    Server()
    {
        ...
        ImageIcon i4= new ImageIcon(ClassLoader.getSystemResource("icons/nabin.png"));
